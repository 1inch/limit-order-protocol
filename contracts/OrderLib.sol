...
library OrderLib {
    ...
    struct Order {
        uint256 salt;
        AddressLib.Address makerAsset;
        AddressLib.Address takerAsset;
        AddressLib.Address maker;
        AddressLib.Address receiver;
        AddressLib.Address allowedSender;  // equals to Zero address on public orders
