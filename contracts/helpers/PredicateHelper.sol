    ...
    function _selfStaticCall(bytes calldata data) internal view returns(bool, uint256) {
        ...
        if (selector < this.or.selector) {  // 0x74261145
            ...
            if (selector < this.and.selector) {  // 0xbfa75143
                ...
                } else if (selector == this.lt.selector) {  // 0xca4ece22
