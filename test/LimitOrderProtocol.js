...
const { buildOrder, buildOrderData, signOrder, makeMakingAmount, skipOrderPermit, buildConstraints, buildOrderRFQ, signOrderRFQ, compactSignature } = require('./helpers/orderUtils');
...
describe('LimitOrderProtocol', function () {
    ...
    describe('wip', function () {
        ...
        it('should not swap with bad signature', async function () {
            ...
            await expect(
                swap.fillOrderRFQ(sentOrder, r, vs, makeMakingAmount(1), 1),
        ...
        it('should not fill below threshold', async function () {
            ...
            const { r, vs } = compactSignature(signature);
            await expect(
                swap.fillOrderRFQ(order, r, vs, 2, 3),
        ...
        it('should fail when amount is zero', async function () {
            ...
            const { r, vs } = compactSignature(signature);
            await expect(
                swap.fillOrderRFQ(order, r, vs, 0, 0),
        ...
        it('should floor maker amount', async function () {
            ...
            const { r, vs } = compactSignature(signature);
            await swap.fillOrderRFQ(order, r, vs, 9, 1);
        ...
        it('should fail on floor maker amount = 0', async function () {
            ...
            const { r, vs } = compactSignature(signature);
            await expect(
                swap.fillOrderRFQ(order, r, vs, 4, 0),
            ).to.be.revertedWithCustomError(swap, 'RFQSwapWithZeroAmount');
        });
        ...
        it('should ceil taker amount', async function () {
            ...
            const { r, vs } = compactSignature(signature);
            await swap.fillOrderRFQ(order, r, vs, makeMakingAmount(4), 1);
        ...
        it('ERC721Proxy should work', async function () {
            ...
            const { r, vs } = compactSignature(signature);
            await swap.fillOrderRFQExt(order, r, vs, makeMakingAmount(10), 10, order.extension);
    ...
    describe('Permit', function () {
        describe('fillOrderRFQToWithPermit', function () {
            ...
            it.only('DAI => WETH', async function () {
                ...
                console.log('targetPermitPair', targetPermitPair)
                const { r, vs } = compactSignature(signature);
                await swap.fillOrderRFQToWithPermit(order, r, vs, makeMakingAmount(1), 1, addr.address, '0x', targetPermitPair);
            ...
            it('rejects reused signature', async function () {
                ...
                const { r, vs } = compactSignature(signature);
                const requestFunc = () => swap.fillOrderRFQToWithPermit(order, r, vs, 1, 1, addr.address, '0x', targetPermitPair);
                await requestFunc();
            ...
            it('rejects other signature', async function () {
                ...
                const { r, vs } = compactSignature(signature);
                await expect(
                    swap.fillOrderRFQToWithPermit(order, r, vs, 1, 1, addr.address, '0x', targetPermitPair),
        ...
        describe('maker permit', function () {
            ...
            it('maker permit works', async function () {
                ...
                await swap.connect(addr1).fillOrderRFQ(order, r, vs, makeMakingAmount(1), 1);
            ...
            it('skips order permit flag', async function () {
                ...
                await swap.connect(addr1).fillOrderRFQ(order, r, vs, skipOrderPermit(1), 0);
    ...
    describe('Amount Calculator', function () {
        ...
        it('empty getTakingAmount should work on full fill', async function () {
            ...
            await swap.fillOrderRFQ(order, r, vs, makeMakingAmount(10), 10);
        ...
        it('empty getMakingAmount should work on full fill', async function () {
            ...
            await swap.fillOrderRFQ(order, r, vs, 10, 10);
    ...
    describe('Expiration', function () {
        ...
        it('should fill partially if not enough coins (taker)', async function () {
            ...
            await swap.fillOrderRFQ(order, r, vs, 3, 2);
        ...
        it('should fill partially if not enough coins (maker)', async function () {
            ...
            await swap.fillOrderRFQ(order, r, vs, makeMakingAmount(3), 3);
    ...
    describe('ETH fill', function () {
        ...
        it('should fill with ETH', async function () {
            ...
            await swap.fillOrderRFQ(order, r, vs, makeMakingAmount(900), 3, { value: 3 });
