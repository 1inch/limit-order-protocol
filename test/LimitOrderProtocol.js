...
describe('LimitOrderProtocol', function () {
    ...
    async function deployContractsAndInit () {
        ...
        const { r, yParityAndS: vs } = ethers.Signature(await signOrder(permits.taker.order, chainId, await swap.getAddress(), addr1));
        ...
        const { r: r1, yParityAndS: vs1 } = ethers.Signature(await signOrder(permits.maker.order, chainId, await swap.getAddress(), addr));
        const { r: r2, yParityAndS: vs2 } = ethers.Signature(await signOrder(permits.maker.orderPermit2, chainId, await swap.getAddress(), addr));
    ...
    describe('Permit2', function () {
        ...
        describe('Maker Permit', function () {
            ...
            it('Fails with unexpected makerAssetSuffix', async function () {
                ...
                const { r, yParityAndS: vs } = ethers.Signature(await signOrder(order, chainId, await swap.getAddress(), addr));
